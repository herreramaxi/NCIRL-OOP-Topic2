 ...
 */
//I took he idea from
//@Reference: https://stackoverflow.com/questions/15989316/how-to-add-a-description-for-each-entry-of-enum
public enum QuestionType {
    ...
    public static Object getEnumDescription(QuestionType questionType) {
        for (QuestionType v : values()) {
            if (v == questionType) {
                return v.toString();
            }
